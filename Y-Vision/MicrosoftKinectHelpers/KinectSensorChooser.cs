...
namespace Microsoft.Kinect.Toolkit
{
    ...
    public class KinectSensorChooser : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Event triggered when the choosen KinectStreamMicrosoftAPI changed.  This is
        ...
        public void TryStartKinectWithId(string connectionId)
        {
        ...
        private void SetSensorAndStatus(CallbackLock callbackLock, KinectSensor newKinect, ChooserStatus newChooserStatus)
        {
            ...
            if (oldKinect != newKinect)
            {
                ...
                callbackLock.LockExit += () => kinectChangedContextWrapper.Invoke(this, new KinectChangedEventArgs(oldKinect, newKinect));
        ...
        private void RaisePropertyChanged(string propertyName)
        {
            ...
            propertyChangedContextWrapper.Invoke(this, new PropertyChangedEventArgs(propertyName));
        }

        public struct Id
        {
            public Id(string uniqueId, string connectionId)
            {
                UniqueId = uniqueId;
        ...
        public static Id[] SensorIdList
        {
            get { return KinectSensor.KinectSensors.Select(k => new Id(k.UniqueKinectId, k.DeviceConnectionId)).ToArray(); }
        }
    }
}
